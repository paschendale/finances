-- Fix ambiguous column references by renaming parameters to p_*
-- We need to DROP first because parameter names are part of the function signature in some versions of Postgres
